<template>
  <div>
    <el-card class="box-card">
      ...
      <el-table style="width: 100%" :data="cateList" border stripe>
        <el-table-column
          ...
          width="100"
        ></el-table-column>
        <el-table-column label="计划名称" prop="cate_name"></el-table-column>
        <el-table-column label="计划别名" prop="cate_alias"></el-table-column>
    ...
    <!-- 添加分类的对话框 -->
    <el-dialog :title="isEdit ? '编辑计划分类' : '添加计划分类'" :visible.sync="addVisible" width="35%" @closed="onAddClosedFn">
      <!-- 添加的表单 -->
      <el-form
        :model="addForm"
        :rules="addRules"
        ...
        label-width="80px"
      >
        <el-form-item label="计划名称" prop="cate_name">
          <el-input
        ...
        <el-form-item label="计划别名" prop="cate_alias">
          <el-input
...
export default {
  ...
  methods: {
    ...
    cancelFn () {
      this.addVisible = false // 对话框内-取消按钮-点击事件
    },
    // 对话框-关闭事件
    onAddClosedFn () {
