      ...
      <div class="thecover">
        ...
        >
          <div class="drawer-content">
            <p class="centered-text" style=" font-weight: bold; font-size: 1.5rem;">
              线路检测覆盖程度
            </p>
            ...
            <p class="centered-text">
              Sed vitae justo non ipsum lacinia consequat.
            </p>
            <p class="centered-text">
              Nulla volutpat nisl nec tellus laoreet, at luctus nisl tristique.
            </p>
          </div>
        </el-drawer>
      </div>
