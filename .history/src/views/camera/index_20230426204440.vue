  ...
  data () {
    return {
      ...
      images: {
        ...
        部位6: require('@/assets/images/p1.jpg'),
        部位7: require('@/assets/images/p2.jpg'),
        部位8: require('@/assets/images/p3.jpg'),
        部位9: require('@/assets/images/p4.jpg'),
        部位10: require('@/assets/images/p5.jpg')
      },
      currentPart: '部位1',
      currentPole: '杆号1',
      canvasWidth: 1041,
