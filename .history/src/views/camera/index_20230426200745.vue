  ...
  <div class="container">
    <div class="sidebar">
      ...
      <div class="toolbar">
        <el-button-group>
          ...
          <el-button v-for="pole in poles" :key="pole" @click="handleChangePole(pole)">{{ pole }}</el-button>
    ...
    <div class="main">
      <div class="header">
        ...
        <el-button-group>
          <el-button v-for="image in images[currentPoleIndex]" :key="image" @click="currentImage = image">{{ image }}</el-button>
        </el-button-group>
      </div>
      ...
      <div class="footer">
        当前选择：{{ currentPole }} - {{ currentPart }} - {{ currentImage }}
      </div>
    </div>
  </div>
</template>
