...
export default {
  data () {
    return {
      ...
      images: {
        ...
        部位2: require('@/assets/images/logo.png'),
        部位3: require('@/assets/images/jt.png'),
        部位4: require('@/assets/images/map.png'),
        杆号1: require('@/assets/images/map.png')
      },
      currentPart: '部位1',
      currentPole: '杆号1',
      canvasWidth: 1041,
  ...
  methods: {
    drawCanvas () {
      ...
      // determine the image source based on the current part and pole
