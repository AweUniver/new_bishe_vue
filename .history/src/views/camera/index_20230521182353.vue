  ...
  <div class="container">
    ...
    <div class="main">
      ...
      <div class="draw-btn-group">
        ...
        <input type="file" @change="uploadImgChange" id="imgInput" accept="image/*" style="display: none;" />
    <img id="img" :src="imgSrc" />
    <img id="expImg" src="@/assets/icons/draw/p5.jpg" style="display: none;" />
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    drawCanvas () {
      ...
      const canvas = new fabric.Canvas('myCanvas')
      fabric.Image.fromURL(this.images[this.currentPart], function (object) {
        const canvasAspectRatio = canvas.width / canvas.height
        ...
        object.set({
          left: 0,
          top: 0,
          scaleX: drawWidth / object.width,
          scaleY: drawHeight / object.height,
          selectable: false
        })
        canvas.clear()
        canvas.add(object)
